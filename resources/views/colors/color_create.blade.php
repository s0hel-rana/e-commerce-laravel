             ...
             <div class="row">
                 <div class="col-md-12">
                     <div class="panel panel-default">
                         ...
                         <div class="card-body">
                             <form class="form-horizontal" action="{{ route('color_store') }}" method="POST">
                                 @csrf
                                 <div class="form-group">
                                     <label class="col-md-4 control-label">Color Name</label>
                                     <div class="col-md-4">
                                         <input type="text" name="name" value="{{ old('name') }}" placeholder="Color Name" class="form-control input-md" />
